...
static const ble_uuid128_t uuid_base = {
    UUID_BASE,
};
...
static const ble_gatts_attr_md_t attr_md_readonly = {
...
static const ble_gatts_attr_md_t attr_md_writeonly = {
    .vloc    = BLE_GATTS_VLOC_STACK,
    .rd_auth = 0,
    .wr_auth = 0,
    .vlen    = 1,
...
static const ble_gatts_attr_t attr_char_info = {
    .p_uuid    = &uuid,
...
static const ble_gatts_attr_t attr_char_command = {
    .p_uuid    = &uuid,
...
static const ble_gatts_char_md_t char_md_readonly = {
...
static const ble_gatts_char_md_t char_md_writeonly = {
    .char_props.broadcast      = 0,
    .char_props.read           = 0,
    .char_props.write_wo_resp  = 0,
    .char_props.write          = 1,
...
//static uint8_t m_ble_evt_buf[BLE_EVTS_LEN_MAX] __attribute__ ((aligned (4)));
